...
public class DownloadService extends Service {
	// notification 名字
	private String notify_name = "正在下载,请稍等...";
	private Context mContext = this;
	Notification mNotification;
	private static final int NOTIFY_ID = 0;
	private NotificationManager mNotificationManager;
	/* 下载包安装路径 */
	private static final String savePath = MoveApplication.getContext().getExternalFilesDir(null).getAbsolutePath();
//	private static final String savePath = Constants.APKPATH;
	private static final String saveFileName = Constants.APKPATH;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Burl = intent.getStringExtra("Url");
		progress = 0;
		setUpNotification();
		new Thread() {
			public void run() {
