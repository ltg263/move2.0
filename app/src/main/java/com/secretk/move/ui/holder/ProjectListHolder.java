...
public class ProjectListHolder extends RecyclerViewBaseHolder {
    ...
    public void refresh(final int position, List<RowsBean> lists, Context context) {
        ...
        GlideUtils.loadCircleProjectUrl(context,ivProjectIcon, Constants.BASE_IMG_URL + rowsBean.getCreateUserIcon());
        tvProjectCode.setText(rowsBean.getCreateUserName());
