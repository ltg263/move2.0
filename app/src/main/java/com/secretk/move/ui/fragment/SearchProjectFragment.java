...
import com.secretk.move.ui.adapter.SearchProjectAdapter;
...
public class SearchProjectFragment extends LazyFragment implements ItemClickListener {
    ...
    public void initViews() {
        ...
        adapter = new SearchProjectAdapter(getActivity());
    ...
    private void getLoadData() {
        ...
        RxHttpParams params = new RxHttpParams.Build()
                ...
                .build();
        RetrofitUtil.request(params, SearchProjectBean.class, new HttpCallBackImpl<SearchProjectBean>() {
            @Override
            public void onCompleted(SearchProjectBean bean) {
                SearchProjectBean.DataBean detailsBean = bean.getData();
